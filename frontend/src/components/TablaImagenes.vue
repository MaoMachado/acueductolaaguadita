          ...
          <tr v-for="img in imagenes" :key="img.id"
            ...
            <td class="p-3 text-center">
              <div class="flex justify-center">
                <img v-if="esUrlImagenValida(img.url)" :src="`http://localhost:3000${img.url}`"
                  ...
                  @click="abrirImagenCompleta(`http://localhost:3000${img.url}`, img.nombre)" />
            ...
            <td class="p-3 text-center">
              <div class="btn-grupo flex justify-center gap-2">
                <a v-if="esUrlImagenValida(img.url)" :href="`http://localhost:3000${img.url}`" download target="_blank"
